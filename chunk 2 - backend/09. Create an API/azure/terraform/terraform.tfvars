...
service_plan_os_type        = "Linux" // The O/S type for the App Services to be hosted in this plan
service_plan_sku            = "Y1"    // The SKU for the plan.
service_plan_zone_balancing = false   // Should the Service Plan balance across Availability Zones in the region. Changing this forces a new resource to be created.